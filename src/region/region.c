...
struct {double newmap;double newmap2;double actmap;double actmap2;double far;int lat;int lon;int num;} pop[NPOP];
...
int main(int argc,char **argv)
{
    ...
    int found,fac,fac0,fac1,dfac,dx1,dy1,de,d,dd,di,dn,dni,dr,
	dy,dx,dy0,dx0,da,*test,nn;
...
/* for(i=0;i<12;i++) {
   ...
   show_map(-1,argv);} exit(0);*/
	...
	/*************************************/
	/*  load map  */
	if(SAGE) /*  load compiled map for new region */
...
/*   read_climber_map("npp_08000.tab",1);*/
	...
	/*      show background map         */
	/*----------------------------------*/
	if(MAGICK &0) show_map(-1,argv),myindex++;  /* show_map(-1,argv);*/
	/* show_map(0,argv);*/
	/*----------------------------------*/
