%% Read plasim for MAya

% Scott's domain:
%Top left: -94.610984  22.491882 Decimal Degrees
%Bottom right: -86.044924  12.498146 Decimal Degrees
...
fdir='/Users/lemmen/projects/maya/netlogo/data';
...
for j=1:length(year)
  ...
  cl_write_arcgis_asc(w,'file',fullfile(fdir,sprintf('plasim_11k_maya_temperature_%04dBP.asc',1950-year(j))),'nodata',-99.0,'xtype','float');
  cl_write_arcgis_asc(p,'file',fullfile(fdir,sprintf('plasim_11k_maya_precipitation_%04dBP.asc',1950-year(j))),'nodata',-99,'xtype','int');

  w=cl_read_arcgis_asc('file',fullfile(fdir,sprintf('plasim_11k_maya_temperature_%04dBP.asc',1950-year(j))),'noprint',0);
  m_coast;

end

for j=1:-10
  w=cl_read_arcgis_asc('file',fullfile(fdir,sprintf('plasim_11k_maya_precipitation_%04dBP.asc',1950-year(j))),'noprint',0);
  m_coast;
end
