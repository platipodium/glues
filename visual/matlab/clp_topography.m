...
nyt=max([20,round((latlim(2)-latlim(1))/4)]);
nxt=max([30,round((lonlim(2)-lonlim(1))/10)]);
...
m_gshhs('ic','color','black','linewidth',0.3,'linestyle','-'); % plot coastline in high resolution
m_gshhs('ib','color','red','linewidth',0.2,'linestyle','-'); % plot boundaries in high resolution
m_gshhs('ir','color','blue','linewidth',0.1); % plot rivers in high resolution
