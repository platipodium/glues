function plot_map_band_events(varargin)
...
if exist(['sig_' scenario '.mat'],'file') load(['sig_' scenario '.mat']); 
else 
...
if exist(['wmap_' scenario '.mat'],'file') load(['wmap_' scenario '.mat']);
