function plot_map_replacemany(fignum,fmin,fmax,year,ratio,dyear,extra,period)
%extra='eleven';
%period='upp';
...
hold on;
m_coast('line','Color',[0.3 0.6 0.3],'LineWidth',2.5);
% db=20*log10(x);
% 20% = 1.5836
% 10% = 0.8279
...
plot_multi_format(gcf,['map_replacemany/map_replacemany_' ending]);
