...
nppt=npp; %TODO: separate npp for tree and grass
nppg=npp;

% leaves, separete for tree and grass
...
function p=initcpar
% Function updated to LOVECLIM2.1 parameter values
% Small changes in variable names for better readability
...
p.k2g=0.55;
p.k4g=0.025;
p.k3g=0025; % up from 0.013, LOVECLIM2.1
p.t3g=1.;
p.t1tn=4;
p.t1td=1;
p.deng=20;
