...
for ir=1:nreg
  ...
  for j=1:ntime
    pr(ir)=plot(repmat(time(itime(j)),2,1),yline-ir/300.,'k-','color',(0.8-ir/10.)*white,'LineWidth',lw/1.3);
  end    

end
legend([p1,p2,pr],'Global','Europe','Lebanon','W Anatolia','N Greece','Croatia','Slovakia','N Germany');

set(gca,'XDir','reverse','Xlim',[3000 12000]);
