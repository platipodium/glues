...
[d,n,e]=fileparts(b);
plot_multi_format(gcf,fullfile(d,['krisen_fig1_gray']));
...
[d,n,e]=fileparts(b);
plot_multi_format(gcf,fullfile(d,['krisen_fig2_gray']));
...
[d,n,e]=fileparts(b);
plot_multi_format(gcf,fullfile(d,['krisen_fig3_gray']));
