function do_plasim_emission
%% Land use and emissions
%  from Plasim-GLUES using
%  Plasim-LSG (11k), 50 a averages
%  GLUES nofluc


kappas=400:50:800;
for i=1:length(kappas)
  scenarios{i}=sprintf('plasim_%3d',kappas(i));
end

scenarios={'plasim_550'}
timelim=[-7000 -2000];
...
for is=length(scenarios):-1:1
  scenario=scenarios{is};
  file=fullfile('../..',[scenario '.nc']);

  [d,b]=clp_nc_variable('file',file,'timelim',-2000,'variable','population_density','scenario',...
    scenario,'noprint',1,'region',reg,'lim',[0,5],'nogrid',1,'showstat',0,'noprint',1);
  cl_print('name',b,'ext','pdf');
  [d,b]=clp_nc_variable('file',file,'timelim',-2000,'variable','farming','scenario',...
    scenario,'noprint',1,'region',reg,'lim',[0,1],'nogrid',1,'showstat',0,'noprint',1);
  cl_print('name',b,'ext','pdf');
  cl_nc_timing('file',file,'timelim',timelim);
  [d,b]=clp_nc_variable('file',file,'variable','farming_timing','scenario',...
    scenario,'noprint',1,'region',reg,'lim',timelim,'nogrid',1,'showstat',0,'noprint',1);
  cl_print('name',b,'ext','pdf');
end
...
for is=1:length(scenarios)
  ...
  [d,b]=clp_nc_variable('file',file,'timelim',-2000,'variable','technology','scenario',...
    scenario,'noprint',1,'region',reg,'lim',[0,10],'nogrid',1,'showstat',0,'noprint',1);
  cl_print('name',b,'ext','pdf');
  [d,b]=clp_nc_variable('file',file,'timelim',-2000,'variable','cropfraction_static','scenario',...
    scenario,'noprint',1,'region',reg,'lim',[0,0.15],'nogrid',1,'showstat',0,'noprint',1);
  cl_print('name',b,'ext','pdf');
  [d,b]=clp_nc_variable('file',file,'timelim',-2000,'variable','albedo_lu','sub','albedo','scenario',...
    scenario,'noprint',1,'region',reg,'lim',[0.,.01],'nogrid',1,'showstat',0,'noprint',1,'cmap','bone');
  cl_print('name',b,'ext','pdf');
 [d,b]=clp_nc_variable('file',file,'timelim',-2000,'variable','albedo_lu','scenario',...
    scenario,'noprint',1,'region',reg,'lim',[0.,1],'nogrid',1,'showstat',0,'noprint',1,'cmap','bone');
  cl_print('name',b,'ext','pdf');
  [d,b]=clp_nc_variable('file',file,'timelim',-2000,'variable','albedo','scenario',...
    scenario,'noprint',1,'region',reg,'lim',[0.,1],'nogrid',1,'showstat',0,'noprint',1,'cmap','bone');
  cl_print('name',b,'ext','pdf');
 
     
     
for time=timelim(1):500:-timelim(2)


[d,b]=clp_nc_variable('file',file,'timelim',time,'variable','population_density','scenario',...
  scenario,'noprint',1,'region',reg,'lim',[0,6],'nogrid',1,'showstat',0,'noprint',1);
cl_print('name',b,'ext','pdf');



continue
[d,b]=clp_nc_variable('file',file,'timelim',time,'variable','cropfraction_static','scenario',...
  scenario,'noprint',1,'region',reg,'lim',[0,0.15],'nogrid',1,'nostat','noprint',11);
cl_print('name',b,'ext','pdf');

[d,b]=clp_nc_variable('file',file,'timelim',time,'variable','farming','scenario',...
  scenario,'noprint',1,'region',reg,'lim',[0,1],'nogrid',1,'nostat',1,'noprint',1);
cl_print('name',b,'ext','pdf');

[d,b]=clp_nc_variable('file',file,'timelim',time,'variable','technology','scenario',...
  scenario,'noprint',1,'region',reg,'lim',[0.5,10],'nogrid',1,'nostat',1,'noprint',1);
cl_print('name',b,'ext','pdf');

[d,b]=clp_nc_variable('file',file,'timelim',time,'variable','economies','scenario',...
  scenario,'noprint',1,'region',reg,'lim',[0,6],'nogrid',1,'nostat',1,'noprint',1);
cl_print('name',b,'ext','pdf');

[d,b]=clp_nc_variable('file',file,'timelim',time,'variable','npp','scenario',...
  scenario,'noprint',1,'region',reg,'lim',[0,6],'nogrid',1,'nostat',1,'noprint',1);
cl_print('name',b,'ext','pdf');
...
[d,b]=clp_nc_variable('file',file,'timelim',[-7000 -1000],'threshold',0.5,'variable','farming','scenario',...
  [scenario '_timing'],'noprint',1,'region',reg,'lim',[0,1],'nogrid',1,'nostat',1,'noprint',1);
cl_print('name',b,'ext','pdf');
...
%% Originating variables (for Europe only)
