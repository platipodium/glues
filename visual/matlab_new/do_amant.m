...
file='/Users/lemmen/projects/glues/tex/2013/aeae/data/amant_nofluc.nc';
ncol=11; cmaps='cl_gray';
%ncol=17; cmaps='cl_gyrm';
if any(doplot==1)
   [d,b]=clp_nc_variable('var','natural_fertility','timelim',[-1000],'latlim',blatlim,'lonlim',blonlim,...
     'marble',0,'transpar',0,'nogrid',1,'file',file,'lim',[0 1],'showtime',0,'showstat',0,'ncol',ncol,'cmap',cmaps,'noprint',1);
   if strfind(cmaps,'gray') 
     m_coast('color','k'); cl_print('name',sprintf('%s_gray',b),'ext','pdf');
   else
     cl_print('name',sprintf('%s_color',b),'ext','pdf');
   end 
   [d,b]=clp_nc_variable('var','economies_potential','timelim',[-1000],'latlim',blatlim,'lonlim',blonlim,...
     'marble',0,'transpar',0,'nogrid',1,'file',file,'flip',0,'showtime',0,'showstat',0,'lim',[0 6],'ncol',ncol,'cmap',cmaps,'noprint',1);
   if strfind(cmaps,'gray') 
     m_coast('color','k'); cl_print('name',sprintf('%s_gray',b),'ext','pdf');
   else
     cl_print('name',sprintf('%s_color',b),'ext','pdf');
   end 
   [d,b]=clp_nc_variable('var','suitable_species','timelim',[-1000],'latlim',blatlim,'lonlim',blonlim,...
     'marble',0,'transpar',0,'nogrid',1,'file',file,'flip',0,'lim',[0 1],'showtime',0,'showstat',0,'ncol',ncol,'cmap',cmaps,'noprint',1); 
   if strfind(cmaps,'gray') 
     m_coast('color','k'); cl_print('name',sprintf('%s_gray',b),'ext','pdf');
   else
     cl_print('name',sprintf('%s_color',b),'ext','pdf');
   end 
   [d,b]=clp_nc_variable('var','suitable_temperature','timelim',[-1000],'latlim',blatlim,'lonlim',blonlim,...
     'marble',0,'transpar',0,'nogrid',1,'file',file,'lim',[0 1],'showtime',0,'showstat',0,'ncol',ncol,'cmap',cmaps,'noprint',1);
   if strfind(cmaps,'gray') 
     m_coast('color','k'); cl_print('name',sprintf('%s_gray',b),'ext','pdf');
   else
   ...
   [d,b]=clp_nc_variable('var','npp','timelim',[-1000],'latlim',blatlim,'lonlim',blonlim,...
     'marble',0,'transpar',0,'nogrid',1,'file',file,'lim',[0 1000],'showtime',0,'showstat',0,'ncol',ncol,'cmap',cmaps,'noprint',1);
   if strfind(cmaps,'gray') 
     m_coast('color','k'); cl_print('name',sprintf('%s_gray',b),'ext','pdf');
   else
     cl_print('name',sprintf('%s_color',b),'ext','pdf');
   end 
   [d,b]=clp_nc_variable('var','temperature_limitation','timelim',[-1000],'latlim',blatlim,'lonlim',blonlim,...
     'marble',0,'transpar',0,'nogrid',1,'file',file,'lim',[0 1],'showtime',0,'showstat',0,'ncol',ncol,'cmap',cmaps,'noprint',1);
   if strfind(cmaps,'gray') 
     m_coast('color','k'); cl_print('name',sprintf('%s_gray',b),'ext','pdf');
   else
...
if any(doplot==2)
   [d,b]=clp_nc_variable('var','farming','timelim',[-7000,1500],'latlim',blatlim,'lonlim',blonlim,...
     'marble',0,'transpar',0,'nogrid',1,'threshold',0.5,'file',file,'flip',1,'showtime',0,'showstat',0,'ncol',ncol,'cmap',cmaps,'noprint',1);
   if strfind(cmaps,'gray') 
     m_coast('color','k'); cl_print('name',sprintf('%s_gray',b),'ext','pdf');
   else
     cl_print('name',sprintf('%s_color',b),'ext','pdf');
...
if any(doplot==3)
  ...
  for i=1:length(eutime)
    ...
    [d,b]=clp_nc_variable('var','population_density','timelim',eutime(i),'latlim',elatlim,'lonlim',elonlim,...
        'marble',0,'transpar',0,'lim',[0 6],'nogrid',1,'showtime',0,'showstat',0,'sce',scenario,'file',file,'ncol',ncol,'cmap',cmaps,'noprint',1);
   if strfind(cmaps,'gray') 
     m_coast('color','k'); cl_print('name',sprintf('%s_gray',b),'ext','pdf');
   else
     cl_print('name',sprintf('%s_color',b),'ext','pdf');
...
if any(doplot==4)
  ...
  for i=1:length(ustime)
    ...
    [d,b]=clp_nc_variable('var','population_density','timelim',ustime(i),'latlim',nlatlim,'lonlim',nlonlim,...
        ...
        'file',file,'ncol',ncol,'cmap',cmaps,'noprint',1,'sce',scenario);
   if strfind(cmaps,'gray') 
     m_coast('color','k'); cl_print('name',sprintf('%s_gray',b),'ext','pdf');
   else
     cl_print('name',sprintf('%s_color',b),'ext','pdf');
